...
public class UpdateOrCancelInitializer {
	...
	public void initSubjectComboBox(JComboBox<Subject> subjectComboBox, JComboBox<Chair> chairComboBox)
		...
		try {
			...
			List<Subject> subjectsList = CommandFacade.getSubjectListByChairAndEduLevel(selectedChair, educationLevel);
	 ...
	 * @throws ServiceException
	 */
	public void initClassroomComboBox(JComboBox<Classroom> classroomComboBox) throws CommandException {
