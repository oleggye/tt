...
public final class FormInitializer {
	...
	public static void initMainForm(JComboBox<Faculty> facultyComboBox, JComboBox<Group> groupComboBox,
			JLabel progressBarLbl, JProgressBar progressBar, byte educationLevel) throws CommandException {
	 ...
	 */
	public static void initFacultyComboBox(JComboBox<Faculty> facultyComboBox) throws CommandException {
	 ...
	 */
	public static void initSubjectComboBox(JComboBox<Subject> subjectComboBox, JComboBox<Chair> chairComboBox,
			byte educationLevel) throws CommandException {

		////HibernateUtil.getSession();
		Chair selectedChair = (Chair) chairComboBox.getSelectedItem();
		try {
			List<Subject> subjectList = CommandFacade.getSubjectListByChairAndEduLevel(selectedChair, educationLevel);
	 ...
	 * @throws ServiceValidationException
	 */
	public static void initLecturerComboBox(JComboBox<Lecturer> lecturerComboBox, JComboBox<Chair> chairComboBox)
	 ...
	 * @throws ServiceValidationException
	 */
	public static void initLecturerComboBox(JComboBox<Lecturer> lecturerComboBox, Chair chair) throws CommandException {
	...
	public static void initGroupComboBox(JComboBox<Faculty> facultyComboBox, JComboBox<Group> groupComboBox,
		...
		try {
			List<Group> groupList = CommandFacade.getGroupListByFacultyAndEduLevel(selectedFaculty, educationLevel);
	 ...
	 * @throws ServiceException
	 */
	public static void initGroupTable(JTable table, Faculty faculty, byte educationLevel) throws CommandException {
		//HibernateUtil.getSession();
		try {
			List<Group> groupList = CommandFacade.getGroupListByFacultyAndEduLevel(faculty, educationLevel);
	 ...
	 * @throws ServiceValidationException
	 */
	public static void initSubjectTable(JTable table, Chair chair, byte educationLevel) throws CommandException {
		//HibernateUtil.getSession();
		try {
			List<Subject> subjectList = CommandFacade.getSubjectListByChairAndEduLevel(chair, educationLevel);
	 ...
	 * @throws ServiceValidationException
	 */
	public static void initFlowGroupTextArea(JTextArea groupInFlowTextArea, Flow flow) throws CommandException {
		//HibernateUtil.getSession();
		try {
