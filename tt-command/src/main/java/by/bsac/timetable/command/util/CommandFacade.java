...
public class CommandFacade {
  ...
  private static <E> void executeVoidCommandWithOneRequestVariable(ActionMode action,
      String variableName, E variableValue) throws CommandException {
    Request request = new Request().putParam(variableName, variableValue);
    executeCommand(action, request);
  }

  private static <E> List<E> getGenericList(ActionMode action, String resultVariableName)
  ...
  private static <E> List<E> getGenericList(ActionMode action, Request request,
      String resultVariableName) throws CommandException {
    executeCommand(action, request);
    return (List<E>) request.getValue(resultVariableName);
  }
  ...
  private static final String OLD_CLASSROOM_VARIABLE = "oldClassroom";
  private static final String NEW_CLASSROOM_VARIABLE = "newClassroom";
  private static final String OLD_LECTURER_VARIABLE = "oldLecturer";
  private static final String NEW_LECTURER_VARIABLE = "newLecturer";
  ...
  public static List<Classroom> getClassroomListByDatesAndRecord(Date referenceDate, Record record)
      throws CommandException {
    Request request =
  ...
  public static List<Group> getGroupListByFacultyAndEduLevel(Faculty faculty, byte eduLevel)
      throws CommandException {
    Request request = new Request().putParam(FACULTY_VARIABLE, faculty)
        .putParam(EDUCATION_LEVEL_VARIABLE, eduLevel);
    return getGenericList(ActionMode.Get_Group_List_By_Faculty_And_EduLevel, request,
        GROUP_LIST_VARIABLE);
  }

  public static List<Subject> getSubjectListByChairAndEduLevel(Chair chair, byte eduLevel)
      throws CommandException {
    Request request =
        new Request().putParam(CHAIR_VARIABLE, chair).putParam(EDU_LEVEL_VARIABLE, eduLevel);
    return getGenericList(ActionMode.Get_Subject_List_By_Chair_And_EduLevel, request,
        SUBJECT_LIST_VARIABLE);
  }
  ...
  public static List<Record> getTimetableForGroup(Group group, Date referenceDate)
      throws CommandException {
    Request request = new Request().putParam(GROUP_VARIABLE, group)
        .putParam(REFERENCE_DATE_VARIABLE, referenceDate);
  ...
  public static void addClassroom(Classroom classroom) throws CommandException {
    executeVoidCommandWithOneRequestVariable(ActionMode.Add_Classroom, CLASSROOM_VARIABLE,
        classroom);
  }
  ...
  public static void updateClassroom(Classroom classroom) throws CommandException {
    executeVoidCommandWithOneRequestVariable(ActionMode.Update_Classroom, CLASSROOM_VARIABLE,
        classroom);
  }
  ...
  public static void deleteLecturer(Lecturer lecturer) throws CommandException {
    executeVoidCommandWithOneRequestVariable(ActionMode.Delete_Lecturer, LECTURER_VARIABLE,
        lecturer);
  }

  public static void deleteClassroom(Classroom classroom) throws CommandException {
    executeVoidCommandWithOneRequestVariable(ActionMode.Delete_Classroom, CLASSROOM_VARIABLE,
        classroom);
  }
  ...
  public static void changeClassroomForAllRecords(Classroom oldClassroom, Classroom newClassroom)
      throws CommandException {
    Request request = new Request().putParam(OLD_CLASSROOM_VARIABLE, oldClassroom)
        .putParam(NEW_CLASSROOM_VARIABLE, newClassroom);
    executeCommand(ActionMode.Change_Classroom, request);
  }

  public static void changeLecturerForAllRecords(Lecturer oldLecturer, Lecturer newLecturer)
      throws CommandException {
    Request request = new Request().putParam(OLD_LECTURER_VARIABLE, oldLecturer)
        .putParam(NEW_LECTURER_VARIABLE, newLecturer);
    executeCommand(ActionMode.Change_Lecturer, request);
  }
}
